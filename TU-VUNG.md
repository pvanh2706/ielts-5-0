...
> AI coach: từ mới xuất hiện trong buổi học thì thêm vào đây (kèm ví dụ đơn giản).
> Từ nào học viên quên ≥2 lần thì đánh dấu ⭐ và đưa vào phần ôn đầu buổi.
> Cấu trúc: giữ MỘT file này khi sổ còn dưới ~200 từ (để học viên lướt ôn một mạch, Ctrl+F dễ).
> Vượt ngưỡng đó thì tách thành thư mục `tu-vung/` chia theo chủ đề, file này thành mục lục.

## Giai đoạn 1 — Từ thông dụng đời sống

| Từ | Loại | Nghĩa | Ví dụ | Ghi chú |
|----|------|-------|-------|---------|
| message | danh từ | lời nhắn | This is a **message** for Mr. Nam. | từ bài nghe 01 |
| call | động từ | gọi điện | Please **call** me at 0903 558 214. | từ bài nghe 01 |
| cost | động từ | có giá (bao nhiêu tiền) | The course **costs** 140 dollars. | từ bài nghe 01; chủ ngữ ngôi 3 → costs |
| course | danh từ | khóa học | The **course** costs 140 dollars. | từ bài nghe 01 |
| floor | danh từ | tầng (nhà) | Room 12 is on the second **floor**. | từ bài nghe 01 |
